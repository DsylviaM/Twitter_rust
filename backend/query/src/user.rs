...
pub struct UpdateProfileParamsInternal {
...
pub fn update_profile(
    ...
    pub fn follow(
        conn: &mut PgConnection,
        user_id: UserId,
        follow: UserId) -> Result<(), DieselError> {
            let uid = user_id;
            let fid = follow;
            {
    ...
    pub fn unfollow(
        conn: &mut PgConnection,
        user_id: UserId,
        stop_following: UserId) -> Result<DeleteStatus, DieselError> {
            let uid = user_id;
