...
pub fn bookmark(
    ...
    user_id: UserId,
    post_id: PostId) -> Result<(), DieselError> {
        let uid = user_id;
        let pid = post_id;
        {
...
pub fn delete_bookmark(
    conn: &mut PgConnection,
    user_id: UserId,
    post_id: PostId) -> Result<DeleteStatus, DieselError> {
        let uid = user_id;
        let pid = post_id;
        {
            use crate::schema::bookmarks::dsl::*;
    ...
    pub fn get_bookmark(
        conn: &mut PgConnection,
        user_id: UserId,
        post_id: PostId) -> Result< bool, DieselError> {
            let uid = user_id;
            let pid = post_id;
            {
                use crate::schema::bookmarks::dsl::*;
    ...
    pub fn get_reaction(
        conn: &mut PgConnection,
        post_id: PostId,
        user_id: UserId) -> Result<Option<Reaction>, DieselError> {
            let pid = post_id;
            let uid = user_id;
            {
...
pub fn boost(
    ...
    user_id: UserId,
    post_id: PostId,
    when: DateTime<Utc>,) -> Result<(), DieselError> {
        let uid = user_id;
        let pid = post_id;
        {
            use crate::schema::boosts::dsl::*;
...
pub fn get_bookmared_posts(conn: &mut PgConnection, user_id: UserId) -> Result<Vec<Post>, DieselError> {
    use crate::schema::{posts, bookmarks};
    bookmarks::table
        .inner_join(posts::table)
...
pub fn get_public_posts(conn: &mut PgConnection, user_id:UserId) -> Result<Vec<Post>, DieselError> {
    use crate::schema::posts;
    posts::table
